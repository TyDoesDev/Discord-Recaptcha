                    ...
                    return interaction.reply({
                        embeds: [
                            new client.DiscordGateway.EmbedBuilder()
                                ...
                                .setDescription(
                                    'Whoops, it seems like you have insufficient permissions to run this command'
                                )
                                .addFields({
                    ...
                    return interaction.reply({
                        embeds: [
                            new client.DiscordGateway.EmbedBuilder()
                                ...
                                .setThumbnail(client.logo)
                                .setDescription(
                                    'Whoops, it looks like your guild has not been configured yet, You can use the `create` config command to create one now!'
                                )
                                .setTimestamp()
                                .setFooter({
                                    text: client.footer,
                    ...
                    return interaction.reply({
                        embeds: [
                            new client.DiscordGateway.EmbedBuilder()
                                ...
                                .setThumbnail(client.logo)
                                .setDescription(
                                    'Whoops, looks like this guild has already been configured, maybe you meant to run the `update` config command?'
                                )
                                .setTimestamp()
                                .setFooter({
                                    text: client.footer,
                            ...
                            interaction.reply({
                                embeds: [
                                    new client.DiscordGateway.EmbedBuilder()
                                        ...
                                        .setThumbnail(client.logo)
                                        .setDescription(
                                            'Your guild config has been created successfully, for reference you can view the settings using the `view` config command'
                                        )
                                        .setTimestamp()
                                        .setFooter({
                                            text: client.footer,
                            ...
                            interaction.reply({
                                embeds: [
                                    new client.DiscordGateway.EmbedBuilder()
                                        ...
                                        .setThumbnail(client.logo)
                                        .setDescription(
                                            'Whoops, i was unable to create your guilds captcha config. Please try again or report this to my dev team'
                                        )
                                        .addFields(
                                            {
                                                name: 'Error Message',
                    ...
                    return interaction.reply({
                        embeds: [
                            new client.DiscordGateway.EmbedBuilder()
                                ...
                                .setThumbnail(client.logo)
                                .setDescription(
                                    'Whoops, looks like your guild does not have a configuration, please run the `create` config command to create one now!'
                                )
                                .setTimestamp()
                                .setFooter({
                                    text: client.footer,
                            ...
                            interation.reply({
                                embeds: [
                                    new client.DiscordGateway.EmbedBuilder()
                                        ...
                                        .setThumbnail(client.logo)
                                        .setDescription(
                                            'Your guilds captcha config has been updated! You can double check the new values by using the `view` config command'
                                        )
                                        .setTimestamp()
                                        .setFooter({
                                            text: client.footer,
                            ...
                            interaction.reply({
                                embeds: [
                                    new client.DiscordGateway.EmbedBuilder()
                                        ...
                                        .setThumbnail(client.logo)
                                        .setDescription(
                                            'Whoops, i was unable to update your guilds captcha config. Please try again or report this to my dev team'
                                        )
                                        .addFields(
                                            {
                                                name: 'Error Message',
